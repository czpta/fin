Use src/views/Dashboard/components/Rest/Rest.js to test concepts, connections, etc. Add Rest to src/views/Dashboard/Dashboard.js in order to activate the component.
